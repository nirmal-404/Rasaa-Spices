            ...
            <div>
                ...
                <CardContent>
                    ...
                    <div className="flex justify-between items-center mb-2">
                        <span className={`${product?.salePrice > 0 ? "line-through" : ""} text-lg font-semibold text-primary`}>LKR {product?.price}</span>
                        {
                            product?.salePrice > 0 ? (
                                <span className="text-lg font-bold">LKR {product?.salePrice}</span>
                            ) : null
                        }
                    </div>
                </CardContent>
