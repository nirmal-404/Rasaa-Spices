...
export const handleProductReportGenaration = (productList) => {
    ...
    for (let i = 0; i < productList.length; i++) {
        ...
        const totalSalePrice = product.salePrice == 0 ?
            product.price * product.totalStock :
            product.salePrice * product.totalStock;
        console.log(product.salePrice, totalSalePrice)
